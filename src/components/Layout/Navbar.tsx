                ...
                <div className="flex w-full justify-between items-center">
                    <div className="flex w-fit">
                        ...
                        >
                            ...
                            <div
                                className="ml-2 flex-none text-sm font-medium uppercase md:hidden lg:block p-2 text-white">
                    ...
                    <FarcasterProvider>
                        <div className="inline-flex w-fit fixed right-10">
                            <div
                                className="absolute top-0 right-0 bottom-0 left-0 bg-primary inline-flex justify-center items-center text-base text-white font-semibold rounded-md pointer-events-none"
                            >
                                {/*<img alt="farcaster logo" src="Farcaster.svg"/>*/}
                                Sign In
                            </div>
                            <SignInButton
